...
# <span style="color:rgb(213,80,0)">Markovレーティング(勝敗)の計算サンプル</span>
...
```matlab
M=zeros(size(teamNames,1),size(teamNames,1));

for n1=1:size(tbl_J1,1)
    tiNum=find(teamNames==tbl_J1.HomeE(n1));
    tjNum=find(teamNames==tbl_J1.AwayE(n1));
    M(tiNum,tjNum)=M(tiNum,tjNum)+tbl_J1.AwayGoals(n1);
    M(tjNum,tiNum)=M(tjNum,tiNum)+tbl_J1.HomeGoals(n1);
end
...
|:--:|:--:|:--:|:--:|
|1|kawasakif|0.0886|1|
|2|yokohamafm|0.0856|2|
|3|kashima|0.0726|3|
|4|kobe|0.0624|4|
|5|cosaka|0.0556|5|
|6|hiroshima|0.0500|6|
|7|ftokyo|0.0499|7|
|8|fukuoka|0.0496|8|
|9|tosu|0.0491|9|
|10|nagoya|0.0482|10|
|11|urawa|0.0475|11|
|12|sapporo|0.0458|12|
|13|shimizu|0.0430|13|
|14|shonan|0.0412|14|
...
xlabel('Markov rating');
exportgraphics(gcf,'MarkovRatingSample.pdf');
```

<center><img src="p158_MarkovSample_media/figure_0.png" width="562" alt="figure_0.png"></center>
